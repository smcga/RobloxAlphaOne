...
- Shows an owner-only admin panel with buttons to multiply current score (`2x`, `10x`) and a guarded reset button that requires a second confirmation click before wiping your own score/rebirths.
...
8. Verify expected MVP behavior:
   ...
   - If you're the game owner, admin panel buttons can multiply your current score by `2x` or `10x`, and can reset your own score/rebirths after a two-click confirmation prompt.
